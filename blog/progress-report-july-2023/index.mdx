...
Behind the scenes, we're full speed ahead on having a comprehensive damage and repair system for vehicles, but we're not at a point where it makes sense to enable true damage yet, so we're keeping them indestructible for now. However, we have made some other quality-of-life improvements to how vehicles are handled in the world.
...
We've re-enabled street lights so when you're in a town or going down a main road, you should be given at least some light to see by.s
